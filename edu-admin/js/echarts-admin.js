 ...
 * @LastEditTime: 2019-04-23 15:15:08
 */
...
option = {
  ...
  legend: {
    data: ['本校派出学生', '全国高校平均派出学生', '省内高校平均派出学生', '本校派出教职工', '全国高校平均派出教职工', '省内高校平均派出教职工'],
    // type: 'scroll',
    orient: 'vertical',
    right: 10,
    top: '30%'
...
// var geoMapChart = echarts.init(document.getElementById('echarts-geoMap'));
...
// geoMapChart.setOption(geoMapOption);


//   外事合作概括
var ctx1 = document.getElementById("chartPie1");
if(ctx1 != null){
  var myPieChart = new Chart(ctx1, {
    type: 'doughnut',
    data: {
      labels: ["签署外事协议", "外事出访", "外事借贷"],
      datasets: [{
        data: [301, 115, 231],
...
//   经费使用情况
var ctx2 = document.getElementById("chartPie2");
if(ctx2 != null){
...
//   在读学生类型
var ctx3 = document.getElementById("chartPie3");
if(ctx3 != null){
...
//   在职教师类型
var ctx4 = document.getElementById("chartPie4");
if(ctx4 != null){
  var myPieChart = new Chart(ctx4, {
    type: 'doughnut',
    data: {
      labels: ["本校教师", "外籍教师", "海外专家"],
      datasets: [{
        data: [210, 200, 100],
        backgroundColor: ['#3ca0ff', '#4ccc71', '#965fe4'],
      }],
